                ...
                <ul>
                    ...
                    <li class="nav-dropdown">
                        ...
                        <ul class="nav-dropdown-menu">
                            ...
                            <li><a href="/settings/infracost" class="active" data-i18n="nav.settings_menu.infracost">Infracost</a></li>
        ...
        <div class="main-content">
            ...
            <header class="top-navbar">
                <div class="navbar-inner">
                    <h2 data-i18n="settings.infracost.title">Infracost</h2>
            ...
            <main class="content-area">
                <div class="content-wrapper">
                    <!-- Settings Card -->
                    <div class="card">
                        <h3 data-i18n="settings.infracost.title">Infracost</h3>
                        <p data-i18n="settings.infracost.description">Configure Infracost settings and options.</p>
                    </div>

                    <!-- Settings Sections -->
                    <div class="activity-section">
                        <div class="activity-header">
                            <h4 data-i18n="settings.infracost.configuration">Configuration</h4>
                        </div>
                        <div class="activity-content">
                            <p data-i18n="settings.infracost.configuration_description">Infracost configuration options will appear here.</p>
                        </div>
                    </div>
                </div>
            </main>
