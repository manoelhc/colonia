                ...
                <ul>
                    ...
                    <li class="nav-dropdown">
                        ...
                        <ul class="nav-dropdown-menu">
                            ...
                            <li><a href="/settings/rabbitmq-integration" class="active" data-i18n="nav.settings_menu.rabbitmq_integration">RabbitMQ Integration</a></li>
        ...
        <div class="main-content">
            ...
            <header class="top-navbar">
                <div class="navbar-inner">
                    <h2 data-i18n="settings.rabbitmq_integration.title">RabbitMQ Integration</h2>
            ...
            <main class="content-area">
                <div class="content-wrapper">
                    <!-- Settings Card -->
                    <div class="card">
                        <h3 data-i18n="settings.rabbitmq_integration.title">RabbitMQ Integration</h3>
                        <p data-i18n="settings.rabbitmq_integration.description">Configure RabbitMQ Integration settings and options.</p>
                    </div>

                    <!-- Settings Sections -->
                    <div class="activity-section">
                        <div class="activity-header">
                            <h4 data-i18n="settings.rabbitmq_integration.configuration">Configuration</h4>
                        </div>
                        <div class="activity-content">
                            <p data-i18n="settings.rabbitmq_integration.configuration_description">RabbitMQ Integration configuration options will appear here.</p>
                        </div>
                    </div>
                </div>
            </main>
